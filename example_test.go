...
//
// Note: The .proto file and the generated code are kept in under an "internal"
// package path to avoid any chance of them appearing in Protean's public API by
// accident. The generated code is not committed to the Git repository. To see
// the generated code, please clone this repository and run "make test".
