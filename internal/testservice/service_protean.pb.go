...
// versions:
// 	protoc-gen-go-protean v0.0.0+2053708
// 	protoc                v3.17.3
...
func ProteanRegisterTestServiceServer(r runtime.Registry, s ProteanTestService) {
	r.RegisterService(&proteanService_TestService{
		proteanMethod_TestService_Unary{s},
		proteanMethod_TestService_ClientStream{s},
		proteanMethod_TestService_ServerStream{s},
		proteanMethod_TestService_BidirectionalStream{s},
	})
}
...
type proteanService_TestService struct {
	methodUnary               proteanMethod_TestService_Unary
	methodClientStream        proteanMethod_TestService_ClientStream
	methodServerStream        proteanMethod_TestService_ServerStream
	methodBidirectionalStream proteanMethod_TestService_BidirectionalStream
}

func (s *proteanService_TestService) Name() string {
	return "TestService"
}

func (s *proteanService_TestService) Package() string {
	return "protean.test"
}

func (s *proteanService_TestService) MethodByName(name string) (runtime.Method, bool) {
	switch name {
	case "Unary":
		return &s.methodUnary, true
	case "ClientStream":
		return &s.methodClientStream, true
	case "ServerStream":
		return &s.methodServerStream, true
	case "BidirectionalStream":
		return &s.methodBidirectionalStream, true
	}
	return nil, false
}
