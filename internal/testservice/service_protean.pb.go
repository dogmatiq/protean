...
// versions:
// 	protoc-gen-go-protean v0.0.0+f9b0e54
// 	protoc                v3.17.3
...
func RegisterProteanTestServiceServer(server runtime.Server, service TestService) {
	server.RegisterService(&protean_TestService_Service{service})
}
...
func (c *protean_TestService_Unary_Call) Send(unmarshal runtime.RawMessage) error {
	req := &Request{}
...
func (c *protean_TestService_ClientStream_Call) Send(unmarshal runtime.RawMessage) error {
	req := &Request{}
	if err := unmarshal(req); err != nil {
		return err
	}
...
func (c *protean_TestService_ServerStream_Call) Send(unmarshal runtime.RawMessage) error {
	req := &Request{}
	if err := unmarshal(req); err != nil {
		return err
	}
...
func (c *protean_TestService_BidirectionalStream_Call) Send(unmarshal runtime.RawMessage) error {
	req := &Request{}
	if err := unmarshal(req); err != nil {
		return err
	}
